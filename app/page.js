...
export default function Home() {
  ...
  return (
    <div style={{ backgroundColor: "var(--bg)" }}>
      ...
      <div className="hidden md:block"><Beet   width={340} height={340} opacity={1} delay={0.8} rotate={10} color="#b01515" className="fixed bottom-[60px] right-[18%] pointer-events-none z-0" /></div>
