    ...
    <html lang="en">
      ...
      >
        ...
        <div aria-hidden="true" className="fixed left-0 bottom-0 flex" style={{ top: "83px", zIndex: 25, pointerEvents: "none", opacity: 0.9 }}>
          <div className="w-1.5 md:w-3 lg:w-5" style={{ backgroundColor: "#b5735a" }} />
          <div className="w-1.5 md:w-3 lg:w-5" style={{ backgroundColor: "#5b8a7a" }} />
          <div className="w-1.5 md:w-3 lg:w-5" style={{ backgroundColor: "#b8963e" }} />
          <div className="w-1.5 md:w-3 lg:w-5" style={{ backgroundColor: "#b07a8a" }} />
          <div className="w-1.5 md:w-3 lg:w-5" style={{ backgroundColor: "#6b7f8a" }} />
        </div>
        {children}
        <DonateButton />
      </body>
